...
final class BakedBezierInterpolator implements Interpolator {
    ...
    public float getInterpolation(float f) {
        ...
        int min = Math.min((int) (((float) (f671b.length - 1)) * f), f671b.length - 2);
        float f2 = (f - (((float) min) * f672c)) / f672c;
        return ((f671b[min + 1] - f671b[min]) * f2) + f671b[min];
    }
}
