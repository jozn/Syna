...
class BitmapHunter implements Runnable {
    ...
    final class C01141 extends ThreadLocal<StringBuilder> {
        C01141() {
        }
    ...
    final class C01152 extends RequestHandler {
        C01152() {
        }
    ...
    final class C01163 implements Runnable {
        final /* synthetic */ RuntimeException val$e;
        final /* synthetic */ Transformation val$transformation;

        C01163(Transformation transformation, RuntimeException runtimeException) {
    ...
    final class C01174 implements Runnable {
        ...
        C01174(StringBuilder stringBuilder) {
    ...
    final class C01185 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C01185(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    final class C01196 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C01196(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    static {
        ...
        NAME_BUILDER = new C01141();
        SEQUENCE_GENERATOR = new AtomicInteger();
        ERRORING_HANDLER = new C01152();
    }
        ...
        while (i < size) {
            ...
            try {
                ...
                if (bitmap == null) {
                    ...
                    Picasso.HANDLER.post(new C01174(append));
                    return null;
                } else if (bitmap == bitmap2 && bitmap2.isRecycled()) {
                    Picasso.HANDLER.post(new C01185(transformation2));
                    return null;
                } else if (bitmap == bitmap2 || bitmap2.isRecycled()) {
                    i++;
                    bitmap2 = bitmap;
                } else {
                    Picasso.HANDLER.post(new C01196(transformation2));
                    return null;
                }
            } catch (RuntimeException e) {
                Picasso.HANDLER.post(new C01163(transformation2, e));
                return null;
            }
        }
        return bitmap2;
