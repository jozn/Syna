...
public class Picasso {
    ...
    final class C01231 extends Handler {
        C01231(Looper looper) {
            super(looper);
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    this.handler.post(new C01241(e2));
                    return;
                }
            }
        }
    ...
    public interface RequestTransformer {
        ...
        final class C01251 implements RequestTransformer {
            C01251() {
            }
    ...
    static {
        HANDLER = new C01231(Looper.getMainLooper());
        singleton = null;
    }
    ...
    void resumeAction(Action action) {
        ...
        if (this.loggingEnabled) {
            Utils.log("Main", Resumed.ELEMENT, action.request.logId());
        }
    }
