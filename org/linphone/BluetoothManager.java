    ...
    public void onReceive(Context context, Intent intent) {
        if (LinphoneManager.isInstanciated()) {
            ...
            if ("android.bluetooth.device.action.ACL_DISCONNECTED".equals(action)) {
                Log.m6028e("Bluetooth Received Event ACTION_ACL_DISCONNECTED");
                if (instance != null) {
                    instance.scoDisconnected();
                    instance.routeAudioToReceiver();
                }
            } else if ("android.bluetooth.device.action.ACL_CONNECTED".equals(action)) {
                Log.m6028e("Bluetooth Received Event ACTION_ACL_CONNECTED");
                if (instance != null) {
                    instance.scoConnected();
                }
            } else if ("android.media.SCO_AUDIO_STATE_CHANGED".equals(action)) {
                int intExtra = intent.getIntExtra("android.media.extra.SCO_AUDIO_STATE", 0);
                Log.m6028e("Bluetooth sco state changed : " + intExtra);
                if (intExtra == 1) {
                    if (instance != null) {
                        instance.scoConnected();
                    }
                ...
                Log.m6028e("Bluetooth state changed: " + intent.getIntExtra("android.bluetooth.adapter.extra.CONNECTION_STATE", 0));
