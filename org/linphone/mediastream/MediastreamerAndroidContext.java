...
public class MediastreamerAndroidContext {
    ...
    private static int parseInt(String str, int i) {
        try {
            ...
            Log.m6028e("Can't parse " + str + " to integer ; using default value " + i);
        }
        return i;
    }
    ...
    public static void setContext(Object obj) {
        if (obj != null) {
            ...
            if (VERSION.SDK_INT >= 19) {
                ...
                Log.m6032i("Setting buffer size to " + parseInt + " and sample rate to " + parseInt(audioManager.getProperty("android.media.property.OUTPUT_SAMPLE_RATE"), 44100) + " for OpenSLES MS sound card.");
            ...
            Log.m6032i("Android < 4.4 detected, android context not used.");
        }
    }
