...
public class AndroidVideoWindowImpl {
    ...
    class C02921 implements Callback {
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            Log.m6032i("Video display surface is being changed.");
            ...
            Log.m6034w("Video display surface changed");
        }

        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            Log.m6034w("Video display surface created");
        }
        ...
        public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
            ...
            Log.m6026d("Video display surface destroyed");
        }
    }

    /* renamed from: org.linphone.mediastream.video.AndroidVideoWindowImpl.2 */
    class C02932 implements Callback {
        C02932() {
        }

        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            Log.m6032i("Video preview surface is being changed.");
            if (AndroidVideoWindowImpl.this.mListener != null) {
            ...
            Log.m6034w("Video preview surface changed");
        }

        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            Log.m6034w("Video preview surface created");
        }
        ...
        public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
            ...
            Log.m6026d("Video preview surface destroyed");
        }
    }
    ...
    public Bitmap getBitmap() {
        if (this.useGLrendering) {
            Log.m6028e("View class does not match Video display filter used (you must use a non-GL View)");
        }
        return this.mBitmap;
    }
    ...
    public void init() {
        this.mVideoRenderingView.getHolder().addCallback(new C02921());
        if (this.mVideoPreviewView != null) {
            this.mVideoPreviewView.getHolder().addCallback(new C02932());
        }
        if (this.useGLrendering) {
    ...
    public void setOpenGLESDisplay(int i) {
        if (!this.useGLrendering) {
            Log.m6028e("View class does not match Video display filter used (you must use a GL View)");
        }
