...
class LinphoneCoreImpl implements LinphoneCore {
    ...
    LinphoneCoreImpl(LinphoneCoreListener linphoneCoreListener) throws IOException {
        this.nativePtr = 0;
        this.mContext = null;
    ...
    LinphoneCoreImpl(LinphoneCoreListener linphoneCoreListener, File file, File file2, Object obj) throws IOException {
        String str = null;
        this.nativePtr = 0;
        this.mContext = null;
        this.mAudioManager = null;
    ...
    private boolean contextInitialized() {
        ...
        Log.m6028e("Context of LinphoneCore has not been initialized, call setContext() after creating LinphoneCore.");
        return false;
    }
    ...
    public void enableSpeaker(boolean z) {
        ...
        if (currentCall != null && currentCall.getState() == State.StreamsRunning && Hacks.needGalaxySAudioHack()) {
            Log.m6026d("Hack to have speaker=", Boolean.valueOf(z), " while on call");
    ...
    public void setVideoDevice(int i) {
        Log.m6032i("Setting camera id :", Integer.valueOf(i));
        if (setVideoDevice(this.nativePtr, i) != 0) {
            Log.m6028e("Failed to set video device to id:", Integer.valueOf(i));
        }
    }
