...
public final class LinphoneUtils {
    ...
    public static final List<LinphoneCall> getCallsInState(LinphoneCore linphoneCore, Collection<State> collection) {
    ...
    public static boolean onKeyVolumeAdjust(int i) {
        ...
        Log.m6032i("Couldn't change softvolume has service is not running");
        return true;
    }
