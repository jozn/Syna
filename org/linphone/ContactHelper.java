...
public final class ContactHelper {
    ...
    private class ContactHelperNew {
        ...
        private final boolean queryNewContactAPI() {
            String str;
            Cursor query;
            String stringBuilder = new StringBuilder(String.valueOf(ContactHelper.this.username)).append("@").append(ContactHelper.this.domain).toString();
            Uri uri = Data.CONTENT_URI;
            String[] strArr = new String[]{"contact_id", "display_name"};
            if (Version.sdkAboveOrEqual(9)) {
                str = "data1" + " = ? AND " + "mimetype" + " = '" + "vnd.android.cursor.item/sip_address" + "'";
                query = ContactHelper.this.resolver.query(uri, strArr, str, new String[]{stringBuilder}, null);
            ...
            str = "data1" + " =  ? AND " + "mimetype" + " = '" + "vnd.android.cursor.item/im" + "' AND lower(" + "data6" + ") = 'sip'";
            query = ContactHelper.this.resolver.query(uri, strArr, str, new String[]{stringBuilder}, null);
    ...
    public boolean query() {
        boolean access$1 = Version.sdkAboveOrEqual(5) ? new ContactHelperNew().queryNewContactAPI() : queryOldContactAPI();
        if (access$1 && !TextUtils.isEmpty(this.displayName)) {
