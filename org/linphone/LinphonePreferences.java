...
public class LinphonePreferences {
    ...
    public void deleteAccount(int i) {
        ...
        if (getLc().getProxyConfigList().length == 0) {
            SipLinphone.m4123a(this.mContext, null).onRegistrationStateChanged(RegistrationState.RegistrationNone);
        } else {
    ...
    public String getAccountTransportKey(int i) {
        ...
        String string = getString(C0282R.string.pref_transport_udp_key);
        return (accountTransport == null || accountTransport != TransportType.LinphoneTransportTcp) ? (accountTransport == null || accountTransport != TransportType.LinphoneTransportTls) ? string : getString(C0282R.string.pref_transport_tls_key) : getString(C0282R.string.pref_transport_tcp_key);
    }

    public String getAccountTransportString(int i) {
        TransportType accountTransport = getAccountTransport(i);
        return (accountTransport == null || accountTransport != TransportType.LinphoneTransportTcp) ? (accountTransport == null || accountTransport != TransportType.LinphoneTransportTls) ? getString(C0282R.string.pref_transport_udp) : getString(C0282R.string.pref_transport_tls) : getString(C0282R.string.pref_transport_tcp);
    }
    ...
    public void setAccountTransport(int i, String str) {
        ...
        if (proxyConfig != null && str != null) {
            try {
                ...
                if (str.equals(getString(C0282R.string.pref_transport_udp_key))) {
                    createLinphoneAddress.setTransport(TransportType.LinphoneTransportUdp);
                } else if (str.equals(getString(C0282R.string.pref_transport_tcp_key))) {
                    createLinphoneAddress.setTransport(TransportType.LinphoneTransportTcp);
                } else if (str.equals(getString(C0282R.string.pref_transport_tls_key))) {
    ...
    public void setUpnpEnabled(boolean z) {
        if (!z) {
            ...
            Log.m6028e("Cannot have both ice and upnp enabled, disabling upnp");
        } else {
