...
public class PrivacyProvider extends IQProvider<Privacy> {
    private static PrivacyItem m5977a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException, SmackException {
        ...
        m5979a(xmlPullParser, privacyItem);
        return privacyItem;
    }

    private static void m5978a(XmlPullParser xmlPullParser, Privacy privacy) throws XmlPullParserException, IOException, SmackException {
        Object obj = null;
        ...
        while (obj == null) {
            ...
            if (next == 2) {
                if (xmlPullParser.getName().equals(Item.ELEMENT)) {
                    arrayList.add(m5977a(xmlPullParser));
                }
    ...
    private static void m5979a(XmlPullParser xmlPullParser, PrivacyItem privacyItem) throws XmlPullParserException, IOException {
    ...
    public Privacy m5980a(XmlPullParser xmlPullParser, int i) throws XmlPullParserException, IOException, SmackException {
