...
public class PingManager extends Manager {
    ...
    final class C02491 implements ConnectionCreationListener {
        C02491() {
        }

        public void m5971a(XMPPConnection xMPPConnection) {
            PingManager.getInstanceFor(xMPPConnection);
        }
    }

    /* renamed from: org.jivesoftware.smackx.ping.PingManager.2 */
    class C02502 extends AbstractIqRequestHandler {
        C02502(String str, String str2, Type type, Mode mode) {
    ...
    class C02513 extends AbstractConnectionClosedListener {
        C02513() {
        }
    ...
    class C02524 implements Runnable {
        C02524() {
        }
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C02491());
    ...
    private PingManager(XMPPConnection xMPPConnection) {
        ...
        this.pingServerRunnable = new C02524();
        ...
        xMPPConnection.registerIQRequestHandler(new C02502(Ping.ELEMENT, Ping.NAMESPACE, Type.get, Mode.async));
        xMPPConnection.addConnectionListener(new C02513());
    ...
    public boolean pingMyServer(boolean z, long j) throws NotConnectedException {
        ...
        if (!ping && z) {
            for (PingFailedListener a : this.pingFailedListeners) {
                a.m4196a();
            }
        }
        return ping;
