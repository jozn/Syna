...
public class Socks5BytestreamRequest implements BytestreamRequest {
    ...
    public Socks5BytestreamSession accept() throws InterruptedException, XMPPErrorException, SmackException {
        ...
        String a = Socks5Utils.m5864a(this.bytestreamRequest.getSessionID(), this.bytestreamRequest.getFrom(), this.manager.getConnection().getUser());
        ...
        for (StreamHost streamHost2 : streamHosts) {
            ...
            if (CONNECTION_FAILURE_THRESHOLD <= 0 || connectionFailures < CONNECTION_FAILURE_THRESHOLD) {
                try {
                    ...
                    socket = new Socks5Client(streamHost2, a).getSocket(max);
                    break;
