...
import org.p075c.p076a.p077a.Cache;
...
public class ServiceDiscoveryManager extends Manager {
    ...
    final class C02171 implements ConnectionCreationListener {
        C02171() {
        }

        public void m5882a(XMPPConnection xMPPConnection) {
    ...
    class C02182 extends AbstractIqRequestHandler {
        C02182(String str, String str2, Type type, Mode mode) {
    ...
    class C02193 extends AbstractIqRequestHandler {
        C02193(String str, String str2, Type type, Mode mode) {
            super(str, str2, type, mode);
        }
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C02171());
    }
    ...
    private ServiceDiscoveryManager(XMPPConnection xMPPConnection) {
        ...
        xMPPConnection.registerIQRequestHandler(new C02182(UserSearch.ELEMENT, DiscoverItems.NAMESPACE, Type.get, Mode.async));
        xMPPConnection.registerIQRequestHandler(new C02193(UserSearch.ELEMENT, DiscoverInfo.NAMESPACE, Type.get, Mode.async));
    }
    ...
    public synchronized void setIdentity(Identity identity) {
        this.identity = (Identity) Objects.m5847a(identity, "Identity can not be null");
        renewEntityCapsVersion();
    }
