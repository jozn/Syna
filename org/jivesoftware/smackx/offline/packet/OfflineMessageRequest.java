...
public class OfflineMessageRequest extends IQ {
    ...
    public static class Provider extends IQProvider<OfflineMessageRequest> {
        private Item m5968a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
            Object obj = null;
        ...
        public OfflineMessageRequest m5969a(XmlPullParser xmlPullParser, int i) throws XmlPullParserException, IOException {
            ...
            while (!z) {
                ...
                if (next == 2) {
                    if (xmlPullParser.getName().equals(org.jivesoftware.smackx.xdata.packet.DataForm.Item.ELEMENT)) {
                        offlineMessageRequest.addItem(m5968a(xmlPullParser));
