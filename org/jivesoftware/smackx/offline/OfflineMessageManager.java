...
public class OfflineMessageManager {
    ...
    class C02471 implements StanzaFilter {
    ...
    public List<Message> getMessages(List<String> list) throws NoResponseException, XMPPErrorException, NotConnectedException {
        ...
        PacketCollector createPacketCollector = this.connection.createPacketCollector(new AndFilter(PACKET_FILTER, new C02471(list)));
        try {
            this.connection.createPacketCollectorAndSend(offlineMessageRequest).nextResultOrThrow();
