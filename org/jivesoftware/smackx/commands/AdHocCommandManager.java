...
public class AdHocCommandManager extends Manager {
    ...
    final class C02111 implements ConnectionCreationListener {
        C02111() {
        }

        public void m5873a(XMPPConnection xMPPConnection) {
    ...
    class C02122 extends AbstractNodeInformationProvider {
        C02122() {
        }
    ...
    class C02133 extends AbstractIqRequestHandler {
        C02133(String str, String str2, Type type, Mode mode) {
    ...
    class C02144 implements LocalCommandFactory {
    ...
    class C02155 extends AbstractNodeInformationProvider {
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C02111());
    }
    ...
    private AdHocCommandManager(XMPPConnection xMPPConnection) {
        ...
        ServiceDiscoveryManager.getInstanceFor(xMPPConnection).setNodeInformationProvider(NAMESPACE, new C02122());
        xMPPConnection.registerIQRequestHandler(new C02133(AdHocCommandData.ELEMENT, NAMESPACE, Type.set, Mode.async));
    ...
    private IQ processAdHocCommand(AdHocCommandData adHocCommandData) throws NoResponseException, NotConnectedException {
            ...
            try {
                ...
                if (localCommand.isLastStage()) {
                    ...
                    if (this.sessionsSweeper == null) {
                        this.sessionsSweeper = new Thread(new C02166());
    ...
    public void registerCommand(String str, String str2, Class<? extends LocalCommand> cls) {
        registerCommand(str, str2, new C02144(cls));
    }
    ...
    public void registerCommand(String str, String str2, LocalCommandFactory localCommandFactory) {
        ...
        this.serviceDiscoveryManager.setNodeInformationProvider(str, new C02155(str2));
    }
}
