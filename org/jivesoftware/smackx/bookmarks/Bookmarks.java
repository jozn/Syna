...
public class Bookmarks implements PrivateData {
    ...
    public static class Provider implements PrivateDataProvider {
        public PrivateData m5857a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
    ...
    private static BookmarkedConference getConferenceStorage(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
