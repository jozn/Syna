...
public final class PubSubManager {
    ...
    public Node createNode(String str, Form form) throws NoResponseException, XMPPErrorException, NotConnectedException {
    ...
    public ConfigureForm getDefaultConfiguration() throws NoResponseException, XMPPErrorException, NotConnectedException {
        return NodeUtils.m5987a(sendPubsubPacket(Type.get, new NodeExtension(PubSubElementType.DEFAULT), PubSubElementType.DEFAULT.getNamespace()), PubSubElementType.DEFAULT);
    }
