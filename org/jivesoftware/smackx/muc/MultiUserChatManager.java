...
public class MultiUserChatManager extends Manager {
    ...
    final class C02451 implements ConnectionCreationListener {

        /* renamed from: org.jivesoftware.smackx.muc.MultiUserChatManager.1.1 */
        class C02441 extends AbstractNodeInformationProvider {
            final /* synthetic */ WeakReference val$weakRefConnection;

            C02441(WeakReference weakReference) {
        ...
        public void m5955a(XMPPConnection xMPPConnection) {
            ServiceDiscoveryManager.getInstanceFor(xMPPConnection).addFeature(MUCInitialPresence.NAMESPACE);
            ServiceDiscoveryManager.getInstanceFor(xMPPConnection).setNodeInformationProvider(MultiUserChatManager.DISCO_NODE, new C02441(new WeakReference(xMPPConnection)));
        }
    }

    /* renamed from: org.jivesoftware.smackx.muc.MultiUserChatManager.2 */
    class C02462 implements StanzaListener {
        C02462() {
        }
        ...
        public void processPacket(Stanza stanza) {
            ...
            if (from.getInvite() != null) {
                ...
                for (InvitationListener a : MultiUserChatManager.this.invitationsListeners) {
                    a.m4233a(MultiUserChatManager.this.connection(), multiUserChat, from.getInvite().getFrom(), from.getInvite().getReason(), from.getPassword(), message);
                }
            }
        }
    }
    ...
    static {
        XMPPConnectionRegistry.addConnectionCreationListener(new C02451());
    ...
    private MultiUserChatManager(XMPPConnection xMPPConnection) {
        ...
        xMPPConnection.addAsyncStanzaListener(new C02462(), INVITATION_FILTER);
    }
