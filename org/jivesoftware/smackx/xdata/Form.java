...
public class Form {
    ...
    private static void validateThatFieldIsText(FormField formField) {
        switch (C02721.$SwitchMap$org$jivesoftware$smackx$xdata$FormField$Type[formField.getType().ordinal()]) {
    ...
    public void setAnswer(String str, String str2) {
        ...
        switch (C02721.$SwitchMap$org$jivesoftware$smackx$xdata$FormField$Type[field.getType().ordinal()]) {
            case VideoSize.CIF /*1*/:
            case VideoSize.HVGA /*2*/:
            case Version.API03_CUPCAKE_15 /*3*/:
