...
public class VersionManager extends Manager {
    ...
    final class C02351 implements ConnectionCreationListener {
        C02351() {
        }

        public void m5898a(XMPPConnection xMPPConnection) {
            VersionManager.getInstanceFor(xMPPConnection);
        }
    }

    /* renamed from: org.jivesoftware.smackx.iqversion.VersionManager.2 */
    class C02362 extends AbstractIqRequestHandler {
        C02362(String str, String str2, Type type, Mode mode) {
            super(str, str2, type, mode);
        }

        public IQ handleIQRequest(IQ iq) {
            return VersionManager.this.ourVersion == null ? IQ.createErrorResponse(iq, new XMPPError(Condition.not_acceptable)) : Version.createResultFor(iq, VersionManager.this.ourVersion);
        }
    }
    ...
    static {
        ...
        XMPPConnectionRegistry.addConnectionCreationListener(new C02351());
    }
    ...
    private VersionManager(XMPPConnection xMPPConnection) {
        ...
        xMPPConnection.registerIQRequestHandler(new C02362(UserSearch.ELEMENT, Version.NAMESPACE, Type.get, Mode.async));
    }
    ...
    public Version getVersion(String str) throws NoResponseException, XMPPErrorException, NotConnectedException {
        return !isSupported(str) ? null : (Version) connection().createPacketCollectorAndSend(new Version(str)).nextResultOrThrow();
    }
