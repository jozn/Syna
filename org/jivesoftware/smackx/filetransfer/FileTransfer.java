...
public abstract class FileTransfer {
    ...
    public double getProgress() {
        return (this.amountWritten <= 0 || this.fileSize <= 0) ? 0.0d : ((double) this.amountWritten) / ((double) this.fileSize);
    }
    ...
    protected void writeToStream(java.io.InputStream r7, java.io.OutputStream r8) throws java.io.IOException {
        /*
        r6 = this;
