...
public class RSMSet implements ExtensionElement {
    ...
    /* synthetic */ class C02671 {
        static final /* synthetic */ int[] f4573x47d3bd1a;

        static {
            f4573x47d3bd1a = new int[PageDirection.values().length];
            try {
                f4573x47d3bd1a[PageDirection.before.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f4573x47d3bd1a[PageDirection.after.ordinal()] = 2;
    ...
    public RSMSet(int i, String str, PageDirection pageDirection) {
        switch (C02671.f4573x47d3bd1a[pageDirection.ordinal()]) {
