...
public class Java7ZlibInputOutputStream extends XMPPInputOutputStream {
    ...
    class C01611 extends InflaterInputStream {
        C01611(InputStream inputStream, Inflater inflater, int i) {
    ...
    class C01622 extends DeflaterOutputStream {
        final /* synthetic */ int val$flushMethodInt;

        C01622(OutputStream outputStream, Deflater deflater, int i) {
    ...
    public InputStream getInputStream(InputStream inputStream) {
        return new C01611(inputStream, new Inflater(), 512);
    }

    public OutputStream getOutputStream(OutputStream outputStream) {
        return new C01622(outputStream, new Deflater(compressionLevel), flushMethod == FlushMethod.SYNC_FLUSH ? SYNC_FLUSH_INT : FULL_FLUSH_INT);
    }
