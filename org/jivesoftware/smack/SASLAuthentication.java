...
public class SASLAuthentication {
    ...
    public void authenticate(String str, String str2, String str3) throws XMPPErrorException, SASLErrorException, IOException, SmackException {
    ...
    public void authenticate(String str, CallbackHandler callbackHandler) throws IOException, XMPPErrorException, SASLErrorException, SmackException {
        SASLMechanism selectMechanism = selectMechanism();
        if (selectMechanism != null) {
            this.currentMechanism = selectMechanism;
            synchronized (this) {
    ...
    public void authenticateAnonymously() throws SASLErrorException, SmackException, XMPPErrorException {
