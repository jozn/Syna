...
public class StreamOpen extends FullStreamElement {
    ...
    /* synthetic */ class C01711 {
        static final /* synthetic */ int[] f4566x2ba30084;

        static {
            f4566x2ba30084 = new int[StreamContentNamespace.values().length];
            try {
                f4566x2ba30084[StreamContentNamespace.client.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f4566x2ba30084[StreamContentNamespace.server.ordinal()] = 2;
    ...
    public StreamOpen(CharSequence charSequence, CharSequence charSequence2, String str, String str2, StreamContentNamespace streamContentNamespace) {
        ...
        this.id = str;
        this.lang = str2;
        switch (C01711.f4566x2ba30084[streamContentNamespace.ordinal()]) {
