...
public abstract class IQ extends Stanza {
    ...
    public boolean isRequestIQ() {
        switch (C01681.$SwitchMap$org$jivesoftware$smack$packet$IQ$Type[this.type.ordinal()]) {
    ...
    public void setType(Type type) {
        this.type = (Type) Objects.m5847a(type, "type must not be null");
    }
