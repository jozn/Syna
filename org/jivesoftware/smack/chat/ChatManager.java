...
public class ChatManager extends Manager {
    ...
    class C01591 extends FlexibleStanzaTypeFilter<Message> {
        C01591() {
        }
    ...
    class C01602 implements StanzaListener {
        C01602() {
        }
    ...
    private ChatManager(XMPPConnection xMPPConnection) {
        ...
        this.packetFilter = new OrFilter(MessageTypeFilter.CHAT, new C01591());
        ...
        xMPPConnection.addSyncStanzaListener(new C01602(), this.packetFilter);
    ...
    private Chat createChat(String str, String str2, boolean z) {
        ...
        this.baseJidChats.put(XmppStringUtils.m5404d(str), chat);
    ...
    private Chat getUserChat(String str) {
        ...
        return (chat == null && this.matchMode == MatchMode.BARE_JID) ? (Chat) this.baseJidChats.get(XmppStringUtils.m5404d(str)) : chat;
    }
    ...
    void closeChat(Chat chat) {
        ...
        this.baseJidChats.remove(XmppStringUtils.m5404d(participant));
    }
