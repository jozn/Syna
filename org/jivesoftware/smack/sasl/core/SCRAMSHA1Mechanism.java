...
public class SCRAMSHA1Mechanism extends SASLMechanism {
    ...
    /* synthetic */ class C01771 {
        static final /* synthetic */ int[] f4569x569b47df;

        static {
            f4569x569b47df = new int[State.values().length];
            try {
                f4569x569b47df[State.AUTH_TEXT_SENT.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f4569x569b47df[State.RESPONSE_SENT.ordinal()] = 2;
    ...
    private static byte[] hi(String str, byte[] bArr, int i) throws SmackException {
        ...
        Object hmac = hmac(bytes, ByteUtils.m5845a(bArr, ONE));
    ...
    protected byte[] evaluateChallenge(byte[] bArr) throws SmackException {
        ...
        switch (C01771.f4569x569b47df[this.state.ordinal()]) {
