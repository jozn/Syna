...
public class SASLDigestMD5Mechanism extends SASLMechanism {
    ...
    /* synthetic */ class C01781 {
        static final /* synthetic */ int[] f4570xa1fe489b;

        static {
            f4570xa1fe489b = new int[State.values().length];
            try {
                f4570xa1fe489b[State.INITIAL.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f4570xa1fe489b[State.RESPONSE_SENT.ordinal()] = 2;
    ...
    static {
        $assertionsDisabled = !SASLDigestMD5Mechanism.class.desiredAssertionStatus() ? true : $assertionsDisabled;
    ...
    protected byte[] evaluateChallenge(byte[] bArr) throws SmackException {
        ...
        switch (C01781.f4570xa1fe489b[this.state.ordinal()]) {
            case VideoSize.CIF /*1*/:
                ...
                bytes = ByteUtils.m5845a(bytes, SASLMechanism.toBytes(':' + this.nonce + ':' + this.cnonce));
