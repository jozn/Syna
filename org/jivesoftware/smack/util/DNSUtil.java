...
public class DNSUtil {
    ...
    final class C01831 implements StringTransformer {
        C01831() {
        }

        public String m5842a(String str) {
            return str;
        }
    }

    /* renamed from: org.jivesoftware.smack.util.DNSUtil.2 */
    /* synthetic */ class C01842 {
    ...
    private static List<HostAddress> resolveDomain(String str, DomainType domainType, List<HostAddress> list) {
        ...
        switch (C01842.$SwitchMap$org$jivesoftware$smack$util$DNSUtil$DomainType[domainType.ordinal()]) {
    ...
    public static List<HostAddress> resolveXMPPDomain(String str, List<HostAddress> list) {
        String a = idnaTransformer.m5841a(str);
        if (dnsResolver != null) {
            return resolveDomain(a, DomainType.Client, list);
        }
        ...
        arrayList.add(new HostAddress(a, 5222));
        return arrayList;
    }
    ...
    public static List<HostAddress> resolveXMPPServerDomain(String str, List<HostAddress> list) {
        String a = idnaTransformer.m5841a(str);
        if (dnsResolver != null) {
            return resolveDomain(a, DomainType.Server, list);
        }
        LOGGER.warning("No DNS Resolver active in Smack, will be unable to perform DNS SRV lookups");
        List<HostAddress> arrayList = new ArrayList(1);
        arrayList.add(new HostAddress(a, 5269));
        return arrayList;
    }
