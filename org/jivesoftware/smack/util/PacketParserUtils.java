...
public class PacketParserUtils {
    ...
    private static String getLanguageAttribute(XmlPullParser xmlPullParser) {
        ...
        while (i < xmlPullParser.getAttributeCount()) {
            ...
            if ("xml:lang".equals(attributeName) || ("lang".equals(attributeName) && Xml.ELEMENT.equals(xmlPullParser.getAttributePrefix(i)))) {
    ...
    public static Feature parseSessionFeature(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        boolean z;
        ParserUtils.assertAtStartTag(xmlPullParser);
        int depth = xmlPullParser.getDepth();
        if (xmlPullParser.isEmptyElementTag()) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static org.jivesoftware.smack.packet.StreamError parseStreamError(org.xmlpull.v1.XmlPullParser r10) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException, org.jivesoftware.smack.SmackException {
        /*
        r4 = 0;
        r5 = -1;
        r0 = 0;
